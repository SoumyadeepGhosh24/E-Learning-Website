...
function scrollAppear() {
  ...
  // contact us form API
// fetch("https://api.apispreadsheets.com/data/bkfRTedLP7xxeB9P/", {
//   method: "POST",
// 	body: JSON.stringify({"data": {"email":"value","message":"value","Last_name":"value","First_name":"value","Additional details":"value"}}),
// }).then(res =>{
// 	if (res.status === 201){
// 		// SUCCESS
...
// feedback form API
// fetch("https://api.apispreadsheets.com/data/c8ueV4Bkok5Ioocr/", {
// 	method: "POST",
// 	body: JSON.stringify({"data": {"Name":"value","Message":"value","email Id":"value"}}),
// }).then(res =>{
// 	if (res.status === 201){
// 		// SUCCESS
// 	}
